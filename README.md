...
- Student seminar delete without token: GitHub issue template `Delete seminar submission` -> same-author ownership check -> `.github/workflows/seminar-delete-issue-to-pr.yml`
